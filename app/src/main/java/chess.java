...
public final class chess extends View {
    private static final String TAG = chess.class.getSimpleName();
    ...
    public chess(final Context context, final AttributeSet attrs) {
        super(context, attrs);
